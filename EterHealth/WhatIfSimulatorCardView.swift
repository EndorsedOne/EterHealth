...
struct WhatIfSimulatorCardView: View {
    ...
    var body: some View {
        let projection = scenario.isEmpty ? nil : WhatIfSimulatorEngine.simulate(scenario, health: health, imports: imports, checkIn: checkIns.entry(), travel: travel.episodeForEvaluation(), travelHistory: travel.episodes)
